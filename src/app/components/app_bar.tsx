                ...
                <div className='max w-full p-6 flex flex-col items-center '>
                    ...
                    <div className='w-full hidden md:block'>
                        ...
                        <ul className="max flex">
                            <li className="hover:text-red-600 font-semibold  pr-12 py-3"><a href={inNotHome ? "/" : "#"}>Accueil</a></li>
                            <li className="hover:text-red-600 font-semibold  pr-12 py-3"><a href={inNotHome ? "/" : "#formations"}>Services</a></li>

                            <li className="hover:text-red-600 font-semibold  pr-12 py-3"><a href={inNotHome ? "/" : "#a-propos"}>A Propos</a></li>
                            <li className="hover:text-red-600 font-semibold  pr-12 py-3"><a href={inNotHome ? "/" : "#contact"}>Contact</a></li>
                        </ul>
                    </div>
...
const MobileAppBar = ({ menuRef, menuIsOpen, inNotHome }: { menuRef: React.RefObject<HTMLDivElement>, menuIsOpen: boolean, inNotHome: boolean }) => (
    <motion.div ref={menuRef}
        ...
        <ul className={`flex flex-col items-center justify-center `}>
            <li className="hover:text-red-600 font-semibold  px-6 py-3"><a href={inNotHome ? "/" : "#"}>Accueil</a></li>
            <li className="hover:text-red-600 font-semibold  px-6 py-3"><a href={inNotHome ? "/" : "#formations"}>Services</a></li>

            <li className="hover:text-red-600 font-semibold  px-6 py-3"><a href={inNotHome ? "/" : "#a-propos"}>A Propos</a></li>
            <li className="hover:text-red-600 font-semibold  px-6 py-3"><a href={inNotHome ? "/" : "#contact"}>Contact</a></li>
        </ul>
